...
urlpatterns = [
    ...
    path(r'makeAppointment', views.makeAppointment, name='makeAppointment'),
    path(r'deleteAppointment', views.deleteAppointment, name='deleteAppointment'),
    path(r'DocGetAppointmentForToday', views.DocGetAppointmentForToday, name='DocGetAppointmentForToday'),
    path(r'getAppointmentList', views.getAppointmentList, name='getAppointmentList'),
    ...
    path(r'appointmentGetDocList', views.appointmentGetDocList, name='appointmentGetDocList'),
    path(r'getAllAppointments', views.getAllAppointments, name='getAllAppointments'),
